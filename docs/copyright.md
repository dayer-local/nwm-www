...
* All Meshtastic-related software, firmware, and source code are the intellectual property of Meshtastic LLC and the generous open-source contributors of the Meshtastic project.
* Any use of the Meshtastic name, terms, or related marks on this website is strictly for descriptive, educational, and identification purposes to explain the underlying technology our network utilizes. 
* We highly respect the creators of this technology. For official information, documentation, and source code regarding the Meshtastic project, please visit their official website at [https://meshtastic.org](https://meshtastic.org).

## 3. Website Framework Attribution (Material for MkDocs)
The technical infrastructure and visual styling of this website are built using **Material for MkDocs**. We gratefully acknowledge the creators and contributors of this open-source project.

* Material for MkDocs is created and maintained by Martin Donath.
* The framework is distributed under the MIT License. 
* Copyright © 2016-2026 Martin Donath <martin.donath@squidfunk.com>.
